	 ...
	 stages {
		...
		steps {
			...
			echo 'This is a GET API test'
                        script {
                                  def myurl = 'http://35.174.22.86:3300/sap/bc/adt/abapunit?sap-client=001&sap-language=EN'
			// Use httpRequest Jenkins Plugin /sap/bc/adt/abapunit/testruns	
                          def response = httpRequest consoleLogResponseBody: true,
                          authentication: 'NPL',  
                          url: 'http://35.174.22.86:3300/sap/bc/adt/abapunit?sap-client=001&sap-language=EN',
